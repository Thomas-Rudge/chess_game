  ...
  describe "#xy_nodes_from_position" do
    context "when positioned at the end of the board" do
      it "gives all positions along the x and y axis relative to @position" do
        piece.position = [7, 4]
        expect(piece.xy_nodes_from_position.sort).to eql [[0, 4], [1, 4], [2, 4], [3, 4],
                                                          [4, 4], [5, 4], [6, 4], [7, 0],
                                                          [7, 1], [7, 2], [7, 3], [7, 5],
                                                          [7, 6], [7, 7]]
      end
    ...
    context "when positioned in the middle of the board" do
      it "gives all verticles positions relative to @positon" do
        piece.position = [4, 3]
        expect(piece.xy_nodes_from_position.sort).to eql [[0, 3], [1, 3], [2, 3], [3, 3],
                                                          [4, 0], [4, 1], [4, 2], [4, 4],
                                                          [4, 5], [4, 6], [4, 7], [5, 3],
                                                          [6, 3], [7, 3]]
      end
  ...
  describe "#verticle_nodes_from_position" do
    context "when positioned at the end of the board" do
      it "gives all verticles positions relative to @position" do
        piece.position = [7, 4]
        expect(piece.verticle_nodes_from_position.sort).to eql [[3, 0], [4, 1], [4, 7], [5, 2],
                                                                [5, 6], [6, 3], [6, 5]]
      end
    end
    ...
    context "when positioned in the middle of the board" do
      it "gives all verticles positions relative to @positon" do
        piece.position = [4, 3]
        expect(piece.verticle_nodes_from_position.sort).to eql [[0, 7], [1, 0], [1, 6], [2, 1],
                                                                [2, 5], [3, 2], [3, 4], [5, 2],
                                                                [5, 4], [6, 1], [6, 5], [7, 0],
                                                                [7, 6]]
      end
